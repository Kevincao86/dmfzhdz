...
Page({
  data: {
    steps: [
      ...
      { key: 'talent', url: '/pages/recruit-talent-pool/recruit-talent-pool', title: 'AI达人池筛选', desc: '', tone: 'indigo' },
      { key: 'schedule', url: '/pages/recruit-schedule/recruit-schedule', title: 'AI排期编排', desc: '', tone: 'cyan' },
