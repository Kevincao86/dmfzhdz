...
def slide_02():
    ...
    wrap_draw(
        d,
        (80, 180),
        "我们天天见老板被抖音、美团推着拍短视频、找达人。真正干活还是微信群和表格：组品不会写，达人对不上号，结账靠截图。所以我们把商家后台和达人端做成一套。",
        f_body(24, True),
        MUTED,
        1760,
    )
...
def slide_05():
    ...
    text(d, (80, 108), "四个入口都在线上，我们可以当场打开", f_title(40), INK)
    rows = [
...
def slide_06():
    ...
    text(d, (110, 760), "见面我们先讲这四个数", f_sans(18), GOLD)
    text(
        d,
        (110, 810),
...
def slide_08():
    ...
    text(
        d,
        (80, 800),
        "夏天加人快。8 月起我们主动放慢，先把供给做扎实。这笔钱不会拿去全国买人。",
        f_body(22, True),
        MUTED,
    )
    text(
...
def slide_11():
    ...
    text(d, s(80, 108), "我们不跟谁抢，接下来一年怎么走", f_title(s(42)), INK)
    comps = [
    ...
    for a, b, c in comps:
        ...
        x += 450
    text(d, s(80, 480), "我们给自己定的数", f_title(s(26)), INK)
    miles = [
    ...
    text(
        d,
        s(80, 910),
        "这些是我们给自己卡的节点。做不到就改，不拿明年故事换今天的钱。",
        f_body(s(20), True),
        MUTED,
    )
    footer(d, 11, scale=2)
...
def slide_13():
    ...
    text(d, s(80, 108), "先到账的 300 万，我们准备这么花", f_title(s(40)), INK)
    text(
        d,
        s(80, 176),
    ...
    uses = [
        (
            ...
            "系统和云",
            GOLD,
            "四端和 212 条接口稳住。模型、存储、云剪按用量付。这轮不拿去重做产品。",
        ),
        (
            "150 万",
            "人工成本",
            RUST,
            "全职两个、兼职三个，商务和交付的人也算在这儿。18 个月工资从这一档出。",
        ),
        (
            "30 万",
            "备用",
        ...
        (
            ...
            "市场拓展",
            TEAL,
            "商家 ERP 和星选小程序一起推。网络推广、杭甬温地推，把 5 家服务商和 13 家注册店做成能付钱的生意。",
        ),
    ]
    y = 240
