...
const TENANT_PAY_ERROR_ZH: Record<string, string> = {
  ...
  missing_session_key: '微信会话已失效，请重新点击微信支付',
  xpay_not_configured: '小程序虚拟支付未配置（offerId/AppKey），请联系管理员在轻量环境变量中配置',
  xpay_product_map_invalid: '虚拟支付道具映射配置无效，请检查 ERP_MP_XPAY_PRODUCT_MAP',
  xpay_prepay_failed: '虚拟支付下单失败，请稍后重试',
