...
export default function AiAgentDrawer() {
  ...
  useEffect(() => {
    if (drawerOpen) setShortcutsOpen(false)
  }, [drawerOpen])
        ...
        <>
          ...
          >
            <motion.div
              ...
              className="flex h-[min(82vh,46rem)] w-full max-w-3xl flex-col overflow-hidden rounded-2xl border border-slate-200/90 bg-white shadow-2xl shadow-slate-900/20"
            ...
            <div className="shrink-0 space-y-2 border-b border-slate-100 bg-slate-50/80 px-4 py-2.5">
            ...
            <div className="shrink-0 border-b border-slate-100">
              ...
              >
                ...
                <span className="inline-flex items-center gap-1 text-[11px] text-slate-400">
                  {shortcutsOpen ? '收起' : '展开'}
                  <ChevronDown
                    className={cn('h-3.5 w-3.5 transition-transform', shortcutsOpen && 'rotate-180')}
                    aria-hidden
                  />
                </span>
              </button>
              {shortcutsOpen ? (
                <div className="grid grid-cols-3 gap-1.5 px-4 pb-2.5">
