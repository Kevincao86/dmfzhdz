...
import opsRegionalPartnersHandler from '../../../商家管理后台/api/_lib/handlers/meoo-ops-regional-partners.ts'
import regionalPartnerLoginHandler from '../../../商家管理后台/api/_lib/handlers/meoo-regional-partner-login.ts'
import regionalPartnerMeHandler from '../../../商家管理后台/api/_lib/handlers/meoo-regional-partner-me.ts'
...
import partnerSalespersonsHandler from '../api/meoo-partner-salespersons.ts'
...
import distributionAffiliatePortalHandler from '../api/meoo-distribution-affiliate-portal.ts'
...
export const ECS_AUTH_API_ROUTE_REVISION = '20260924-bind-probe-before-sms'
...
const routes: Record<string, VercelLikeHandler> = {
  ...
  '/api/meoo-ops-regional-partners': opsRegionalPartnersHandler as VercelLikeHandler,
  '/api/meoo-regional-partner-login': regionalPartnerLoginHandler as VercelLikeHandler,
  '/api/meoo-regional-partner-me': regionalPartnerMeHandler as VercelLikeHandler,
  ...
  '/api/meoo-partner-salespersons': partnerSalespersonsHandler as VercelLikeHandler,
  ...
  '/api/meoo-distribution-affiliate-portal': distributionAffiliatePortalHandler as VercelLikeHandler,
...
function applyErpApiCors(res: ServerResponse): void {
  ...
  res.setHeader(
    ...
    'Content-Type, Authorization, X-Mp-Session, X-Meoo-Douyin-Token, X-Meoo-Kuaishou-Token, X-Meoo-Meituan-Token, X-Meoo-Xhs-Token, X-Meoo-Access-Token',
  )
}
