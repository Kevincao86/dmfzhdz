/** POST /api/meoo-kuaishou-poi-claim — 同 POST /api/merchant/kuaishou/stores/poi/claim */
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  await runMerchantApiGatewayFromPath(req, res, `/api/merchant/kuaishou/stores/poi/claim${search}`)
}
