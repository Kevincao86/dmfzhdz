/**
 * POST /api/meoo-kuaishou-goods-product-save — 等价于 POST /api/merchant/kuaishou/goods/product/save
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  await runMerchantApiGatewayFromPath(req, res, `/api/merchant/kuaishou/goods/product/save${search}`)
}
