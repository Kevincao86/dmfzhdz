/**
 * GET /api/meoo-meituan-goods-products — 等价于 GET /api/merchant/meituan/goods/products
 */
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  await runMerchantApiGatewayFromPath(req, res, `/api/merchant/meituan/goods/products${search}`)
}
