/**
 * GET /api/meoo-kuaishou-goods-product-draft-query — 等价于
 * GET /api/merchant/kuaishou/goods/product/draft/query
 */
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  await runMerchantApiGatewayFromPath(
    req,
    res,
    `/api/merchant/kuaishou/goods/product/draft/query${search}`,
  )
}
