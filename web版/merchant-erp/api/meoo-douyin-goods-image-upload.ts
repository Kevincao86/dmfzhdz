/**
 * POST /api/meoo-douyin-goods-image-upload — 等价于 POST /api/merchant/douyin/goods/image/upload
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  await runMerchantApiGatewayFromPath(req, res, `/api/merchant/douyin/goods/image/upload${search}`)
}
