/**
 * GET /api/meoo-marketing-activities — 等价于 GET /api/merchant/marketing/activities
 */
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  await runMerchantApiGatewayFromPath(req, res, `/api/merchant/marketing/activities${search}`)
}
