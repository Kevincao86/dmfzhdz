/** GET /api/meoo-kuaishou-store-detail — 同 /api/merchant/kuaishou/stores/detail */
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  await runMerchantApiGatewayFromPath(req, res, `/api/merchant/kuaishou/stores/detail${search}`)
}
