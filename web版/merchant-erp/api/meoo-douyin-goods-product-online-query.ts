/**
 * GET /api/meoo-douyin-goods-product-online-query — 等价于
 * GET /api/merchant/douyin/goods/product/online/query（团购单品名称线上匹配）
 */
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  await runMerchantApiGatewayFromPath(
    req,
    res,
    `/api/merchant/douyin/goods/product/online/query${search}`,
  )
}
