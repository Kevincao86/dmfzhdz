/**
 * POST /api/meoo-ops-mp-recruitment-ice-submit — 云剪任务：达人回传抖音作品链接并 AI 核查。
 */
...
import { isIceMpOrder, submitIceDouyinForApplicant } from '../src/lib/mpRecruitmentIceCore.js'
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  try {
    ...
    let body: { mpOrderId?: string; applicantId?: string; douyinPublishUrl?: string }
    try {
    ...
    sendOpsJson(res, 500, {
      ok: false,
      error: 'meoo_ops_mp_recruitment_ice_submit_failed',
