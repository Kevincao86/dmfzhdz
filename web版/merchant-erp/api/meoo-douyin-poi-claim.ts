/** POST /api/meoo-douyin-poi-claim — 同 POST /api/merchant/douyin/stores/poi/claim */
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  await runMerchantApiGatewayFromPath(req, res, `/api/merchant/douyin/stores/poi/claim${search}`)
}
