/**
 * 仅服务 Vercel `/api/merchant/douyin/bind`：与 vite-plugins/douyinMerchantGateway 中绑定链路逻辑对齐，
 * 但不 import 整份网关（约 2k 行），避免 Serverless 打包/冷启动异常导致 FUNCTION_INVOCATION_FAILED。
 */
...
/** 与 douyinMerchantGateway.runDouyinMerchantBind 返回约定一致 */
