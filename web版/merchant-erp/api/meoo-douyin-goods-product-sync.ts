/**
 * POST /api/meoo-douyin-goods-product-sync — 等价于 POST /api/merchant/douyin/goods/product/sync
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  await runMerchantApiGatewayFromPath(req, res, `/api/merchant/douyin/goods/product/sync${search}`)
}
