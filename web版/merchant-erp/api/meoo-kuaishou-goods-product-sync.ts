/**
 * POST /api/meoo-kuaishou-goods-product-sync — 等价于 POST /api/merchant/kuaishou/goods/product/sync
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  await runMerchantApiGatewayFromPath(req, res, `/api/merchant/kuaishou/goods/product/sync${search}`)
}
