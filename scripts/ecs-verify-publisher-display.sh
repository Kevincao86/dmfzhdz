...
echo ""
echo "==> GET ${BASE}/meoo-ops-mp-publisher-display?mpOrderId=${MP_ID}"
curl -sS -m 25 "${BASE%/}/meoo-ops-mp-publisher-display?mpOrderId=${MP_ID}" | head -c 600
echo ""
