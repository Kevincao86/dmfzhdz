...
copy_mapped "pages/subpack-pr/mine-pr-order-schedule/mine-pr-order-schedule.js" "pages/mine-pr-order-schedule/mine-pr-order-schedule.js"
copy_mapped "pages/subpack-pr/mine-pr-order-schedule/mine-pr-order-schedule.wxml" "pages/mine-pr-order-schedule/mine-pr-order-schedule.wxml"
copy_mapped "pages/subpack-pr/mine-pr-order-schedule/mine-pr-order-schedule.wxss" "pages/mine-pr-order-schedule/mine-pr-order-schedule.wxss"
copy_mapped "pages/subpack-pr/mine-pr-order-applicants/mine-pr-order-applicants.js" "pages/mine-pr-order-applicants/mine-pr-order-applicants.js"
copy_mapped "pages/subpack-pr/mine-pr-order-applicants/mine-pr-order-applicants.wxml" "pages/mine-pr-order-applicants/mine-pr-order-applicants.wxml"
copy_mapped "pages/subpack-pr/mine-pr-order-applicants/mine-pr-order-applicants.wxss" "pages/mine-pr-order-applicants/mine-pr-order-applicants.wxss"
copy_mapped "utils/visitScheduleBoard.js" "utils/visitScheduleBoard.js"
copy_mapped "utils/visitScheduleRuntime.js" "utils/visitScheduleRuntime.js"
copy_mapped "utils/mpGroupQr.js" "utils/mpGroupQr.js"
