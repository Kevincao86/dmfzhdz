...
PRESERVE_KEYS=(
  ...
  MP_WECHAT_SECRET
  ERP_MP_WECHAT_APPID
  ERP_MP_WECHAT_SECRET
  MP_DOUYIN_APPID
  MP_DOUYIN_SECRET
  MP_DOUYIN_WEB_CLIENT_KEY
  MP_DOUYIN_WEB_CLIENT_SECRET
  MP_DOUYIN_WEB_REDIRECT_URI
  MP_AUTH_DEV_MODE
  MP_DEV_FIXED_OPENID
  ...
  FEISHU_SUPPORT_RECEIVE_ID
  FEISHU_SUPPORT_RECEIVE_ID_TYPE
  MEOO_FEISHU_WEBHOOK_URL
  MEOO_FEISHU_WEBHOOK_SUPPORT
  MEOO_FEISHU_WEBHOOK_OFFICIAL
  MEOO_FEISHU_WEBHOOK_OFFICIAL_SECRET
  MEOO_FEISHU_WEBHOOK_LINGQI
  MEOO_FEISHU_WEBHOOK_LINGQI_SECRET
  MEOO_FEISHU_WEBHOOK_SECRET
  MEOO_FEISHU_NOTIFY_ENABLED
