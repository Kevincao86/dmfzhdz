import type { RegistryRecruitmentOrder, RegistrySnapshot } from './opsRegistryTypes.js'
...
export function patchRecruitmentOrderInSnapshot(
  ...
  data.recruitmentOrders[idx] = {
    ...
    ...(body.scheduleMeta ? { scheduleMeta: { ...(cur as RegistryRecruitmentOrder).scheduleMeta, ...body.scheduleMeta } } : {}),
