...
export type RegistryFile = {
  ...
  /** 拍摄团队版会员权限版本 */
  shootMembershipPlanVersions?: import('./mpMembershipCatalog').MpMembershipPlanVersion[]
  /** 剪辑团队版会员权限版本 */
  editMembershipPlanVersions?: import('./mpMembershipCatalog').MpMembershipPlanVersion[]
  /** 星选平台会员开通支付申报（待运营确认） */
