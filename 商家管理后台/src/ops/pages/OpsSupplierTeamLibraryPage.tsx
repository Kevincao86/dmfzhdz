...
import { readOpsSession, sessionCanEditModule } from '../opsStaffAuth'
...
export default function OpsSupplierTeamLibraryPage({ role }: Props) {
  ...
  const permKey = role === 'shoot' ? 'shoot_team_library' : 'edit_team_library'
  const canEdit = sessionCanEditModule(session, permKey)
  ...
  return (
    <div className="mx-auto max-w-[1400px] space-y-6">
      ...
      <OpsMembershipPlanVersionsPanel role={role} canEdit={canEdit} />
