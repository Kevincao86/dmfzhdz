...
const OPS_NAV: {
  ...
  { to: '/help-manual/fulfillment', label: '履约版', icon: BookOpen, permission: 'help_manual', indent: true },
  { to: '/help-manual/mp', label: '小程序使用手册', icon: BookOpen, permission: 'help_manual', indent: true },
