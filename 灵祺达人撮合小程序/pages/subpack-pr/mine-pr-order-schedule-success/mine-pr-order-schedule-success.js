...
Page({
  ...
  goVideoReview() {
    wx.navigateTo({
      url: `/pages/subpack-pr/mine-pr-orders/mine-pr-orders?tab=pending_video_review`,
    })
  },
  goApplicants() {
  ...
  goOrders() {
    wx.navigateTo({ url: '/pages/subpack-pr/mine-pr-orders/mine-pr-orders?tab=pending_schedule' })
  },
})
