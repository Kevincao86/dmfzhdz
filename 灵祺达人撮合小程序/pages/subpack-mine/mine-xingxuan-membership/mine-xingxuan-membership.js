...
Page({
  ...
  async onShow() {
    ...
    if (!ok) {
      guestRoutes.redirectToLogin('/pages/subpack-mine/mine-xingxuan-membership/mine-xingxuan-membership')
      return
    }
    await this.reload()
  },
  ...
  onGoMyOrders() {
    wx.navigateTo({ url: '/pages/subpack-mine/mine-my-orders/mine-my-orders?tab=membership' })
  },
  onCompareBenefits() {
