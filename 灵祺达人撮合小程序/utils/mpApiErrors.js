...
const ZH = {
  ...
  wechat_prepay_not_jsapi: '支付通道异常，请稍后重试',
  wechat_prepay_native_not_supported_in_mp: '小程序不支持扫码支付，请更新后台后重试',
  'requestPayment:no_permission': '暂无微信支付权限，请使用真机调试或联系管理员',
  ...
  group_qr_missing_on_order: '群二维码未同步到服务器，请重新上传后再通知',
  group_qr_missing: '群二维码未同步到服务器，请重新上传后再通知',
  invalid_entries: '所选达人信息不完整，无法发送通知',
  empty_entries: '没有可通知的达人',
  meoo_ops_mp_talent_inbox_append_failed: '发送站内信失败，请稍后重试',
  ...
  http_502: '后台服务正在重启，请稍后重试',
  http_503: '后台服务暂不可用，请稍后重试',
  http_504: '请求超时，请检查网络后重试',
