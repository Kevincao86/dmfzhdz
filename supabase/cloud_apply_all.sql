...
-- ---------- 20260524120000_ops_staff_accounts（运营管控台主/子账号）----------
...
-- ---------- 20260601120000_tenant_partner_edition（服务商版）----------
alter table public.tenants
...
drop policy if exists "tenant_partner_clients_select_member" on public.tenant_partner_clients;
...
drop policy if exists "tenant_partner_clients_insert_member" on public.tenant_partner_clients;
...
drop policy if exists "tenant_partner_clients_update_member" on public.tenant_partner_clients;
...
drop policy if exists "tenant_partner_clients_delete_member" on public.tenant_partner_clients;
