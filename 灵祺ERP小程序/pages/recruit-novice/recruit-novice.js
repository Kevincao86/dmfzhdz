...
Page({
  ...
  async onSubmit() {
    ...
    if (!this.data.allocationFresh) {
      wx.showToast({
        title: plat.id === '小红书' ? '请先点击小红书人数估算' : '请先点击分配达人档位',
        icon: 'none',
      })
      return
    }
