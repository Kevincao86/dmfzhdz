...
| `/ai-agent` | 灵祺助手 | — | 已剔除 | 手机端不适合；已下线 Tab 与页面 |
...
| `/operation/ai-ops-plan` | 运营方案 | `pages/ai-ops-plan/ai-ops-plan` | 对齐 | |
| `/ai-image` | 视觉工坊 | `pages/ai-visual-studio/ai-visual-studio` | 对齐 | |
| `/ai-operation/content` | 爆款 Brief | `pages/ai-content/ai-content` | 对齐 | |
| `/ai-operation/video-check` | 短视频出片 | `pages/shortvideo-ai` + voice/edit | 对齐 | 手机端已剔除无限画布 |
| `/ai-operation/short-drama` | 短剧制作 | `pages/short-drama/short-drama` | 已补 | 场景钩子 · 竖屏成片 |
